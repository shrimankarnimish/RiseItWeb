...
import img1 from "../../../public/Assets/Images/career.jpg";
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 mt-12">
        {/* Left Section */}
        <div>
          <h2 className="titleabout mb-6">Work With Us</h2>
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <input
                  type="file"
                  accept=".pdf,.doc,.docx"
                  className="w-full px-4 py-2 rounded-lg bg-gray-200 text-gray-700 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-[#2E8BFF] file:text-white hover:file:bg-[#1f6fd6] focus:outline-none"
                />
